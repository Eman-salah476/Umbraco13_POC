...
namespace LinkDev.GAFI.EgyptReady.Web.Controllers.BackOffice.SurveyBuilder
{
    ...
    [Tree("surveyBuilder", "TemplatesAlias",
         TreeTitle = "Templates", TreeGroup = "templatesGroup", SortOrder = 7)]
    public class TablesTreeController : TreeController
    {
        ...
        public TablesTreeController(ILocalizedTextService localizedTextService,
